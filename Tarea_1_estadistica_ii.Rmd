...
juntos <- hist_salarios_densidad +
  ...
  scale_color_manual(values = c("blue", "red", "green", "purple", "orange", "turquoise"), labels = Kernels) + labs(color = "Kernel")
...
Del cual, se obtiene que el intervalo de confianza al 95% para la media es [1077392, 1084455] y para la desviación estándar es [592319.0, 597556.4].